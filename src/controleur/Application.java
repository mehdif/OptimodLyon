...
public class Application {
	...
	public Application() {
		...
		tournee.chargerDonneesDemandeXML("xmlPourTests/livraisonSimplifie_BienForme_AnomaliePointInconnu.xml");
	...
	public void afficherItineraire() {
		 ...
		 * 
		 * Point point0 = points.get(0); Point point1 = points.get(1); Point
		 * point2 = points.get(2); Point point3 = points.get(3); Point point4 =
		 * points.get(4); Point point5 = points.get(5); Point point6 =
		 * points.get(6);
		 * 
		 ...
		 * 
		 * VueItineraire uneVueItineraire = new
		 * VueItineraire(unItineraire.getTroncons(), Color.RED); VueTournee
		 * uneVueTournee = new VueTournee();
